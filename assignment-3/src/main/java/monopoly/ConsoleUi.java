...
public class ConsoleUi {
  ...
  public String promptForNewPlayerName() {
    System.out.println("Player name (empty when done): ");
  ...
  /**
   * User can select if allow computer player to join.
   */
  public char promptForPlayModeSelection() {
    System.out.print("Add computer player for the game (y/n): ");
    try {
      BufferedReader reader = new BufferedReader(new InputStreamReader(System.in, Charset.defaultCharset().name()));
  ...
  /**
   * Prompts for and returns new computer players name.
   */
  public String promptForNewComputerPlayerName() {
    System.out.print("Give computer player name (empty when done): ");
    try {
      BufferedReader reader = new BufferedReader(new InputStreamReader(System.in, Charset.defaultCharset().name()));
      return reader.readLine();
    } catch (IOException e) {
  ...
  public Action promptForAction(String playerName) {
    ...
    System.out.println("r to roll dice, b to buy property");
  ...
  /**
   * Simple computer player implementation, computer can decide game behaviour.
   */
  public Action promptForComputerAction(String playerName) {
    System.out.println("It is your turn: " + playerName);
    System.out.println("r to roll dice, b to buy property");
    char [] options = {'r', 'b'};
    int index = new Random().nextInt(2);
    char choice = options[index];
